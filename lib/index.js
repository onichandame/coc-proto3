...
var DemoList = class extends import_coc.BasicList {
  constructor(nvim) {
    super(nvim);
    this.name = "demo_list";
    this.description = "CocList for coc-proto3";
  ...
  async loadItems(context) {
    return [
      {
        label: "coc-proto3 list item 1",
        data: {name: "list item 1"}
      },
      {
        label: "coc-proto3 list item 2",
...
async function activate(context) {
  import_coc2.window.showMessage(`coc-proto3 works!`);
  context.subscriptions.push(import_coc2.commands.registerCommand("coc-proto3.Command", async () => {
    import_coc2.window.showMessage(`coc-proto3 Commands works!`);
  }), import_coc2.listManager.registerList(new lists_default(import_coc2.workspace.nvim)), import_coc2.sources.createSource({
    name: "coc-proto3 completion source",
    doComplete: async () => {
      const items = await getCompletionItems();
      return items;
    }
  }), import_coc2.workspace.registerKeymap(["n"], "proto3-keymap", async () => {
